...
namespace artery {
    ...
    namespace sionna {
        ...
        template <typename Float, typename Spectrum, typename OutValue, typename InValue>
        static OutValue convert(InValue value) {
            return impl<Float, Spectrum, OutValue, InValue>::convert(value);
        }
        ...
        template <typename Float, typename Spectrum, typename OutValue, typename InValue, typename STUBBER>
        struct impl : CompatImpl<Float, Spectrum, OutValue, InValue, STUBBER> {};
