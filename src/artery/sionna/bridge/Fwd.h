...
// Looks like this till this issue is fixed: https://github.com/mitsuba-renderer/mitsuba3/issues/1851
...
namespace artery {
    ...
    namespace sionna {
        ...
        namespace py SIONNA_BRIDGE_INTERNAL {
            ...
            MI_VARIANT class AntennaPattern;
            MI_VARIANT class PolarizedAntennaPattern;
        ...
        MI_VARIANT struct SionnaBridgeAliases {
            ...
            using AntennaPattern = py::AntennaPattern<Float, Spectrum>;
            using PolarizedAntennaPattern = py::PolarizedAntennaPattern<Float, Spectrum>;
...
#define SIONNA_BRIDGE_IMPORT_BRIDGE_TYPES()                                                \
    ...
    using AntennaPattern = typename SionnaBridgeAliases::AntennaPattern;                   \
    using PolarizedAntennaPattern = typename SionnaBridgeAliases::PolarizedAntennaPattern; \
