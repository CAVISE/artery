...
namespace artery {
    ...
    namespace sionna {
        ...
        public:
            // Initialize object from Mitsuba properties.
            static RadioMaterialBase fromProperties(mitsuba::Properties properties);
        ...
        public:
            ...
            static RadioMaterial fromProperties(
                ...
                SimpleConstant<double, false>::ActualOrConstant thickness = constants::DEFAULT_THICKNESS,
...
MI_VARIANT artery::sionna::RadioMaterial<Float, Spectrum> artery::sionna::RadioMaterial<Float, Spectrum>::fromProperties(
    const std::string& name,
    SimpleConstant<double, false>::ActualOrConstant thickness,
