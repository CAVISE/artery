...
Setup instructions:
  ...
  git merge upstream/master --no-ff
    ...
    parser.add_argument("base", type=Path, help=r"Ancestor file")
    parser.add_argument("current", type=Path, help=r"Current branch file")
    parser.add_argument("other", type=Path, help=r"Other branch file")
    parser.add_argument("path", type=str, help="Original file path")
